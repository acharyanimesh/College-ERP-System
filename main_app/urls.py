...
urlpatterns = [
    ...
    path("admin_notify_student/course/<int:course_id>/", hod_views.notify_student_by_course,
         name='notify_student_by_course'),
    path("admin_notify_student/course/<int:course_id>/semester/<int:semester>/", hod_views.notify_student_by_semester,
         name='notify_student_by_semester'),
    ...
    path("attendance/view/course/<int:course_id>/", hod_views.admin_attendance_by_course,
         name='admin_attendance_by_course'),
    path("attendance/view/student/<int:student_id>/", hod_views.admin_student_attendance,
         name='admin_student_attendance'),
    ...
    path("student/manage/course/<int:course_id>/", hod_views.manage_student_by_course, name='manage_student_by_course'),
    path("student/manage/course/<int:course_id>/semester/<int:semester>/", hod_views.manage_student_by_course_semester, name='manage_student_by_course_semester'),
    path("student/manage/course/<int:course_id>/semester/<int:semester>/shift/<str:shift>/", hod_views.manage_student_by_course_semester_shift, name='manage_student_by_course_semester_shift'),
    path("student/manage/course/<int:course_id>/semester/<int:semester>/promote/", hod_views.promote_class, name='promote_class'),
    path("student/passed-out/", hod_views.passed_out_students, name='passed_out_students'),
    path("student/passed-out/course/<int:course_id>/", hod_views.passed_out_by_course, name='passed_out_by_course'),
    path("student/passed-out/course/<int:course_id>/session/<int:session_id>/", hod_views.passed_out_by_session, name='passed_out_by_session'),
    path("student/details/<int:student_id>", hod_views.student_details, name='student_details'),
    path("course/manage/", hod_views.manage_course, name='manage_course'),
    path("subject/manage/course/<int:course_id>/", hod_views.manage_subject_by_course, name='manage_subject_by_course'),
    path("subject/manage/course/<int:course_id>/semester/<int:semester>/", hod_views.manage_subject_by_semester, name='manage_subject_by_semester'),
    path("subject/view/<int:subject_id>", hod_views.subject_details, name='subject_details'),
    path("staff/view/<int:staff_id>", hod_views.staff_details, name='staff_details'),
    path("staff/edit/<int:staff_id>", hod_views.edit_staff, name='edit_staff'),
    path("staff/assign-subjects/<int:staff_id>",
         hod_views.assign_staff_subjects, name='assign_staff_subjects'),
